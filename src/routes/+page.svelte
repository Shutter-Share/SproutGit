      ...
      <ResizableSidebar storageKey="home" defaultWidth={256} minWidth={220} maxWidth={420}>
        ...
        >
          ...
          <div class="flex flex-col gap-1.5 p-3">
            ...
            >
              <span
                class="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-[var(--sg-primary)]/12 text-[var(--sg-primary)] transition-colors group-hover:bg-[var(--sg-primary)]/20"
              >
              ...
              <ArrowRight
                size={14}
                class="shrink-0 text-[var(--sg-text-faint)] opacity-0 transition-opacity group-hover:opacity-100"
              />
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span class="flex-1 text-left"
                >{#if opening}Opening…{:else}Open{/if}</span
              >
              <ArrowRight
                size={14}
                class="shrink-0 text-[var(--sg-text-faint)] opacity-0 transition-opacity group-hover:opacity-100"
