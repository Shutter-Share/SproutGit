...
>
  ...
  />
  <span
    class={`${align === 'center' ? 'mt-0' : 'mt-0.5'} inline-flex h-4 w-4 shrink-0 items-center justify-center rounded border border-[var(--sg-input-border)] leading-none ${checked
      ? variant === 'danger'
